...
from . import views
from .views import PortfolioCreateView, RegisterView, PortfolioListView, PortfolioEditView, \
    PortfolioDeleteView, TransactionCreateView, TransactionDeleteView, TransactionEditView, TransactionListView, \
    SearchFinancialInstrumentView, HomeView, LoginView, LogoutView
